...
const ViewShipment = () => {
  ...
  if (error) return <div className="text-center text-red-800">Error: {error}</div>;
            ...
            <tr key={shipment._id} className="hover:bg-gray-50">
                ...
                {editingId === shipment._id ? (
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      className="bg-blue-800 text-white px-3 py-1 rounded-md hover:bg-blue-900"
                    >
                      Update
                    </button>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      className="bg-yellow-800 text-white px-3 py-1 rounded-md hover:bg-yellow-900"
                    >
                      Edit
                    </button>
                  </div>
              ...
              <td className="py-2 px-4 border-b">
                <button
                  ...
                  className="bg-green-800 text-white px-3 py-1 rounded-md hover:bg-green-900"
                >
                  View
                </button>
              </td>
