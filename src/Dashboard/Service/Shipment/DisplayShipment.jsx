...
const DisplayShipment = () => {
  ...
  if (loading) return <p className="text-center text-gray-900">Loading...</p>;
  if (shipmentError) return <p className="text-center text-red-900">Shipment Error: {shipmentError}</p>;
  if (!shipment) return <p className="text-center text-gray-900">Shipment not found</p>;
    ...
    <div className="bg-gray-100 min-h-screen flex items-center justify-center p-6">
      <div className="bg-white p-8 rounded-lg shadow-xl w-full">
        <div className="flex justify-between items-center mb-8">
          <button
            onClick={handleBack}
            className="flex items-center px-4 py-2 bg-blue-900 text-white font-semibold rounded-md shadow-md hover:bg-blue-700 transition duration-300 ease-in-out"
          >
