    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <form onSubmit={handleCreateBranch} className="mb-6 bg-white p-6 shadow-md rounded-lg">
        ...
        <div className="space-y-4">
          ...
          <button
            type="submit"
            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-800 hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-800"
            disabled={submitting}
          >
      ...
      <div className="bg-white p-6 shadow-md rounded-lg">
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead>
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Branch Name</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Password</th>
            </tr>
          </thead>
          <tbody className="bg-white divide-y divide-gray-200">
            {branches.map((branch) => (
              <tr key={branch._id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{branch.password}</td>
              </tr>
            ))}
          </tbody>
        </table>
