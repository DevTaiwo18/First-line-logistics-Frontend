...
const ViewPriceSinglePage = () => {
  ...
  if (error) return <div className="text-center text-red-800">{error}</div>;

  if (!singlePrice) return <div className="text-center text-gray-900">Price not found.</div>;
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <div className="mb-6">
        <button
          onClick={handleBack}
          className="px-4 py-2 bg-gray-300 text-gray-700 font-semibold rounded-md shadow-md hover:bg-gray-800 flex items-center transition duration-300 ease-in-out"
        >
      ...
      <div className="bg-white border border-gray-300 rounded-lg shadow-lg p-8 space-y-6">
        ...
        <div className="flex space-x-4">
          <button
            ...
            className="px-5 py-2 bg-yellow-900 text-white font-semibold rounded-lg shadow-md hover:bg-yellow-700 flex items-center transition duration-300 ease-in-out"
          >
            <FaEdit className="mr-2" /> Edit
          </button>
          <button
            onClick={handleDelete}
            className="px-5 py-2 bg-red-900 text-white font-semibold rounded-lg shadow-md hover:bg-red-700 flex items-center transition duration-300 ease-in-out"
          >
