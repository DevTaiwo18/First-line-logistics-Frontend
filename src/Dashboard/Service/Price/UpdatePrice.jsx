...
const UpdatePrice = () => {
    ...
    if (error) return <p className="text-red-800">Error: {error.message}</p>;
    ...
    return (
        <div className="p-4 border rounded shadow-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" className="px-4 py-2 bg-blue-800 text-white font-semibold rounded-md shadow-md hover:bg-blue-900 transition duration-300 ease-in-out">
                    Update Price
                </button>
            </form>
        </div>
