...
const ViewPrice = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      {prices.length === 0 ? (
        <div className="text-center text-gray-900">No prices available.</div>
      ) : (
                  ...
                  <td className="py-2 px-4 border-b text-gray-900">
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="px-3 py-1 bg-blue-900 text-white font-semibold rounded-md shadow-sm hover:bg-blue-700 flex items-center"
                      >
                        <FaEye className="mr-1" /> View
                      </button>
                      <button
                        onClick={() => handleDelete(price._id)}
                        className="px-3 py-1 bg-red-900 text-white font-semibold rounded-md shadow-sm hover:bg-red-700 flex items-center"
                      >
