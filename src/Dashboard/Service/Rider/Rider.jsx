    ...
    return (
        <div className="p-6 bg-white shadow-2xl min-h-screen">
            ...
            <form className="space-y-6 mb-8" onSubmit={handleSubmit}>
                <div className="flex gap-8">
                    <div className="flex-1">
                        <label className="block text-gray-900 text-lg font-semibold">Rider Name</label>
                        <input
                            type="text"
                            value={riderName}
                    ...
                    <div className="flex-1">
                        <label className="block text-gray-900 text-lg font-semibold">Vehicle Model</label>
                        <input
                            type="text"
                            value={vehicleModel}
                ...
                <div className="flex gap-8">
                    <div className="flex-1">
                        <label className="block text-gray-900 text-lg font-semibold">License Plate</label>
                        <input
                            type="text"
                    ...
                    <div className="flex-1">
                        <label className="block text-gray-900 text-lg font-semibold">Contact Number</label>
                        <input
                            type="text"
                            value={contactNumber}
                ...
                <div className="flex gap-8">
                    <div className="flex-1">
                        <label className="block text-gray-900 text-lg font-semibold">Vehicle Type</label>
                        <select
                            value={vehicleType}
            ...
            <div className="bg-gray-100 p-4 rounded-lg">
                {riders.length === 0 ? (
                    <p className="text-gray-900">No rider records available.</p>
                ) : (
