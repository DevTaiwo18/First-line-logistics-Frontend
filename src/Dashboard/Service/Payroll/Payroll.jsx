  ...
  return (
    <div className="p-6 bg-white shadow-2xl min-h-screen">
      ...
      <form className="space-y-6 mb-8" onSubmit={handleSubmit}>
        <div className="flex gap-8">
          <div className="flex-1">
            <label className="block text-gray-900 text-lg font-semibold">Employee Name</label>
            <input
              type="text"
              value={employeeName}
          ...
          <div className="flex-1">
            <label className="block text-gray-900 text-lg font-semibold">Role</label>
            <select
              value={role}
        ...
        <div className="flex gap-8">
          <div className="flex-1">
            <label className="block text-gray-900 text-lg font-semibold">Branch</label>
            <select
              value={branch}
          ...
          <div className="flex-1">
            <label className="block text-gray-900 text-lg font-semibold">Pay Period</label>
            <select
              value={payPeriod}
        ...
        <div className="flex gap-8">
          <div className="flex-1">
            <label className="block text-gray-900 text-lg font-semibold">Basic Salary</label>
            <input
              type="text"
          ...
          <div className="flex-1">
            <label className="block text-gray-900 text-lg font-semibold">Overtime Pay</label>
            <input
              type="text"
        ...
        <div className="flex gap-8">
          <div className="flex-1">
            <label className="block text-gray-900 text-lg font-semibold">Bonuses</label>
            <input
              type="text"
          ...
          <div className="flex-1">
            <label className="block text-gray-900 text-lg font-semibold">Tax Deductions</label>
            <input
              type="text"
        ...
        <div className="flex gap-8">
          <div className="flex-1">
            <label className="block text-gray-900 text-lg font-semibold">Other Deductions</label>
            <input
              type="text"
          ...
          <div className="flex-1">
            <label className="block text-gray-900 text-lg font-semibold">Gross Pay</label>
            <input
              type="text"
        ...
        <div className="flex gap-8">
          <div className="flex-1">
            <label className="block text-gray-900 text-lg font-semibold">Total Deductions</label>
            <input
              type="text"
          ...
          <div className="flex-1">
            <label className="block text-gray-900 text-lg font-semibold">Net Pay</label>
            <input
              type="text"
        ...
        <button
          type="submit"
          className="px-4 py-2 bg-green-900 text-white font-semibold rounded-lg hover:bg-green-700 focus:outline-none"
        >
      ...
      <div className="bg-gray-100 p-4 rounded-lg">
        {payrolls.length === 0 ? (
          <p className="text-gray-900">No payroll records available.</p>
        ) : (
